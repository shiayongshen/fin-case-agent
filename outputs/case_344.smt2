...
; Case ID: case_344
; Generated at: 2025-10-21T07:40:31.788351
;
...
(declare-const violate_148_2 Bool)
...
(assert (= violate_148_1_2 (or violate_148_1 violate_148_2)))
...
(assert (= violate_148_2_2
   (or (not public_explanation_made)
...
; [meta:penalty_conditions] 處罰條件：違反第148-1、148-2、148-3條相關規定時處罰
(assert (= penalty
   (or violate_148_1_2
       violate_148_2_1
       violate_148_2_2
