...
; Case ID: case_426
; Generated at: 2025-10-21T09:22:31.199630
;
...
; [insurance:capital_level_4_measures_completed] 資本嚴重不足等級措施完成
(assert (= capital_level_4_measures_completed level_4_measures_executed))

; [insurance:capital_level_3_measures_completed] 資本顯著惡化等級措施完成
(assert (= capital_level_3_measures_completed level_3_measures_executed))

; [insurance:capital_level_2_measures_completed] 資本不足等級措施完成
