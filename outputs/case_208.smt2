...
; Case ID: case_208
; Generated at: 2025-10-21T04:34:15.435137
;
...
(declare-const capital_level_other Bool)
...
(assert (= (ite capital_level_lower_priority 1 0)
   (ite (<= capital_level (ite capital_level_other 1 0))
        capital_level
        (ite capital_level_other 1 0))))
...
(assert (let ((a!1 (or (and (= 3 capital_level)
